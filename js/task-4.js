function getShippingCost(country) {
	switch (country) {
		case 'Australia':
			...
			break
		case 'China':
			return 'Shipping to Australia will cost 100 credits'
			break
		case 'Chile':
			return 'Shipping to Australia will cost 250 credits'
			break
		case 'Jamaica':
...
console.log(getShippingCost('Sweden')) // "Sorry, there is no delivery to your cou
